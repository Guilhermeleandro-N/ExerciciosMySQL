...
ALTER TABLE DUPLICATAS CHANGE VALOR Valor float;
ALTER TABLE DUPLICATAS CHANGE BANCO Banco char(40);

INSERT INTO DUPLICATAS (NOME,NUMERO,VALOR, VENCIMENTO, BANCO) VALUES ('ABC PAPELARIA', 100100, 5000.00, '2017-01-20', 'ITAU'),
